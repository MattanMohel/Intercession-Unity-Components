...
public class XVelocity : IConditional {
    ...
    public bool evaluate(GameObject obj) {
        return Conditional.ApplyOp(obj.GetComponent<Rigidbody2D>().velocity.x, xVel, cmp);
    }
...
public class YVelocity : IConditional {
    ...
    public bool evaluate(GameObject obj) {
        return Conditional.ApplyOp(obj.GetComponent<Rigidbody2D>().velocity.y, yVel, cmp);
    }
